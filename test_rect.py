...
#           [0.59, 0.96, 0.41, 0.97],
#           [0.76, 0.15, 0.05, 0.38]])
weight = np.around(np.random.uniform(low=0.01, high=0.99, size=(neuron_size, len(fitur))), decimals=2)

model = som.train_SOM(weight, dataset.values, Alpha, c, R, Et, E0, number_col)
